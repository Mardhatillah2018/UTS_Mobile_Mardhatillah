...
import 'package:uts_mardhatillah_2201092018/page/page_detail_berita.dart';
  ...
  Future<List<Datum>?> getBerita() async {
    try {
      ...
      http.Response response = await http.get(
        Uri.parse("http://192.168.231.154/uts_mobile/berita.php"),
      );
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: Image.network(
                                      'http://192.168.231.154/uts_mobile/image/${data.gambar}',
                                      fit: BoxFit.fill,
                                    ),
                                  ),
                                ),
